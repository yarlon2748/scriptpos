...
<div class="row">
  ...
  <div class="col-md-8">
    ...
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form id="formularioCliente" name="formularioCliente" role="form" enctype="multipart/formdata">
        <div class="card-body">
          ...
          <!-- <div class="form-group">
            ...
            <div class="input-group">
              <div class="custom-file">
                ...
                <label class="custom-file-label" for="foto">Seleccion archivo</label>
              </div>
        ...
        <div class="card-footer">
          <button type="submit" class="btn btn-primary" value="Guardar" id="operacion" name="operacion">Enviar</button>
        </div>
      </form>
      <div id="respuesta">
...
<script src="<?php echo($URL) ?>/layout/cliente/index.js"></script>
<script>
  $(function () {
    $("#example1").DataTable({
